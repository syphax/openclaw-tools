...
echo "Installing Daily Digest launchd agents..."
echo "Detected paths:"
LAUNCH_PATH=$(detect_launch_path)
echo ""

install_agent "com.openclaw.daily-digest"
install_agent "com.openclaw.health-check"

echo "Done. To check status:"
echo "  launchctl print gui/${UID_VAL}/com.openclaw.daily-digest"
echo "  launchctl print gui/${UID_VAL}/com.openclaw.health-check"
echo ""
echo "To uninstall:"
echo "  launchctl bootout gui/${UID_VAL} ~/Library/LaunchAgents/com.openclaw.daily-digest.plist"
echo "  launchctl bootout gui/${UID_VAL} ~/Library/LaunchAgents/com.openclaw.health-check.plist"
