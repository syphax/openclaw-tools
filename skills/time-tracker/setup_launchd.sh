...
echo "Installing Time Tracker launchd agent..."
echo "Detected paths:"
LAUNCH_PATH=$(detect_launch_path)
echo ""

install_agent "com.openclaw.time-tracker"

echo "Done. To check status:"
echo "  launchctl print gui/${UID_VAL}/com.openclaw.time-tracker"
echo ""
echo "To uninstall:"
echo "  launchctl bootout gui/${UID_VAL} ~/Library/LaunchAgents/com.openclaw.time-tracker.plist"
